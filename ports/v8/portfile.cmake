...
vcpkg_from_git(
    ...
    REF 4dc61d3cd02f0a2462cc655095db1e99ad9047d2
...
v8_fetch(
        ...
        REF a99f0cc42967cb19d95f64b1e0e0ed52792fec79
        SOURCE ${SOURCE_PATH}
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    ...
    configure_file(${CURRENT_PORT_DIR}/V8Config-shared.cmake ${CURRENT_PACKAGES_DIR}/share/v8/V8Config.cmake)
    ...
    configure_file(${CURRENT_PORT_DIR}/V8Config-static.cmake ${CURRENT_PACKAGES_DIR}/share/v8/V8Config.cmake)
endif()
